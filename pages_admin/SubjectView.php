                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="page-header clearfix">
                                        ...
                                        <a href="subjectAdd.php" class="btn btn-dark pull-right" style="float: right">Add New Subject</a>
                                    </div>					
                                    <?php 
                                        ...
                                        while ($row = $result->fetch_assoc())
                                        {
                                            ...
                                            echo 
                                                '<tr>
                                                            ...
                                                            <td><a href="SubjectUpdate.php?id='. $row['subjectID'].'" title="Update Subject" data-toggle="tooltip" class="icon"><i class="fas fa-pen icon"></i></a></td>
