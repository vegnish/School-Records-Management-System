                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        {
                                            $class_name_sql = "SELECT className, yearGrade FROM class WHERE classID='".$row['classID']."';";
                                            ...
                                            echo 
                                                '<tr>
                                                            ...
                                                            <td>
                                                                <a href="StudentGradesView.php?id='.$row['studentID'].'&firstname='.$row['firstName'].'&lastname='.$row['lastName'].'&gender='.$row['gender'].'&yeargrade='.$class_name_row['yearGrade'].'" title="View Scores" data-toggle="tooltip" class="icon"><i class="fas fa-eye"></i></a>
                                                            </td>
                                                        </tr>';
                                        }
